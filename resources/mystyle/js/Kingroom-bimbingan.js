...
function recomTA1ThisGuys(a){
	modalStaticMultipleButton('Apakah anda yakin ingin merekomendasikan mahasiswa dengan nim '+a+" dari bimbingan anda untuk seminar?",function(){
		resommitThisGuysTA1(a);	
	});
}
function recomTA2ThisGuys(a){
	modalStaticMultipleButton('Apakah anda yakin ingin merekomendasikan mahasiswa dengan nim '+a+" dari bimbingan anda untuk sidang?",function(){
