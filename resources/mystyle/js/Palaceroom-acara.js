			...
			if(parseInt(a[0]) ==  3){
				...
				if(jsonList.kode){
					for(i=0;i<jsonList.content;i++){		
						...
						if(jsonList[i].id.substr(0,2) == "TS"){
							tempIDListTable[jsonList[i].id]['allowPrint'] = jsonList[i].allowPrint;
						}
		...
		CalendersRev[DATA.ID] = $("#"+DATA.ID).fullCalendar({
			...
			eventClick: function(calEvent, jsEvent, view) {
				...
				if(calEvent.id.substr(0,2) == "TS"){
					if(tempIDListTable[calEvent.id]['allowPrint'] == 2)
						buttonTolak += 
						"<div style='margin-bottom:5px;'>"+
						"<button class='btn btn-clean btn-success' onclick='getNoSuratTAS("+'"ta1"'+").setA("+'"'+calEvent.id+'"'+").showNoSurat()' style=' cursor : pointer;' title='print surat penguji'><span class='icon-print'>&nbsp;Undangan</span></button>"+
						"</div>";
					else
						buttonTolak += 
						"<div style='margin-bottom:5px;'>"+
						"<button disabled class='btn btn-clean btn-danger' style='' title='print surat penguji'><span class='icon-print'>&nbsp;Undangan</span></button>"+
						"</div>";
					...
					if(tempIDListTable[calEvent.id]['ketua'] != ""){
						buttonTolak += "<button class='btn btn-clean btn-success' onclick='getNoSuratTAD("+'"ta2"'+").setAAndB("+'"'+calEvent.id+'"'+" , "+'"'+tempIDListTable[calEvent.id]['ketua']+'"'+").showNoSurat()' style='cursor : pointer;' title='print surat ketua'><span class='icon-print'>&nbsp;ketua</span></button>";
					}else{
						buttonTolak += 
						"<button disabled class='btn btn-clean btn-danger'><span class='icon-remove' style='color : red;' title='print surat ketua'>&nbsp;ketua</span></button>";
					}
					if(tempIDListTable[calEvent.id]['pengujis'] != ""){
						buttonTolak += "&nbsp;&nbsp;<button class='btn btn-clean btn-success' onclick='getNoSuratTAD("+'"ta2"'+").setAAndB("+'"'+calEvent.id+'"'+" , "+'"'+tempIDListTable[calEvent.id]['pengujis']+'"'+").showNoSurat()' style='cursor : pointer;' title='print surat penguji 1'><span class='icon-print'>&nbsp;penguji 1</span></button>";
					}else{
						buttonTolak += 
						"&nbsp;&nbsp;<button disabled class='btn btn-clean btn-danger'><span class='icon-remove' style='color : red;' title='print surat penguji 1'>&nbsp;penguji 1</span></button>";
					}
					if(tempIDListTable[calEvent.id]['pengujid'] != ""){
					buttonTolak += "&nbsp;&nbsp;<button class='btn btn-clean btn-success' onclick='getNoSuratTAD("+'"ta2"'+").setAAndB("+'"'+calEvent.id+'"'+" , "+'"'+tempIDListTable[calEvent.id]['pengujid']+'"'+").showNoSurat()' style='cursor : pointer;' title='print surat penguji 2'><span class='icon-print'>&nbsp;penguji 2</span></button>";
					}else{
						buttonTolak += 
						"&nbsp;&nbsp;<button disabled class='btn btn-clean btn-danger'><span class='icon-remove' style='color : red;' title='print surat penguji 2'>&nbsp;penguji 2</span></button>";
					}
					if(tempIDListTable[calEvent.id]['pengujit'] != ""){
						buttonTolak += "&nbsp;&nbsp;<button class='btn btn-clean btn-success' onclick='getNoSuratTAD("+'"ta2"'+").setAAndB("+'"'+calEvent.id+'"'+" , "+'"'+tempIDListTable[calEvent.id]['pengujit']+'"'+").showNoSurat()' style='cursor : pointer;' title='print surat penguji 3'><span class='icon-print'>&nbsp;penguji 3</span></button>";
					}else{
						buttonTolak += 
						"&nbsp;&nbsp;<button disabled class='btn btn-clean btn-danger'><span class='icon-remove' style='color : red;' title='print surat penguji 3'>&nbsp;penguji 3</span></button>";
					}
					...
					"</div>"
					 ...
					 modalStaticSingleInformation("Kegiatan dari mahasiswa ",
					 "<div style='width : 100%;'>"+
						"<div id='ta2-content-base' >"+
							 "<table style='width : 100%; font-family : Arial; font-size : 10pt;'>"+
								"<tr >"+
					...
					if(wkwk2.isBefore(neutral)){
						buttonTolak += 
						"<div style='margin-bottom:5px;'>"+
							"<button class='btn btn-clean btn-warning' disabled><span class='icon-remove' style='color : red;' title='menghapus even'> hapus</span></button>"+
							"&nbsp;&nbsp;<button class='btn btn-clean btn-primary' disabled><span class='icon-edit' title='berita acara'> ubah</span></button>"+
						"</div>";
					}else{
						buttonTolak +=
						"<div style='margin-bottom:5px;'>"+
							"<button class='btn btn-clean btn-warning' style='cursor : pointer;' onclick='alertAdminEvent("+'"ac"'+").showDelete();'><span class='icon-remove' title='menghapus even'> hapus</span></button>"+
