...
function realBannishThisGuysFromSeminar(ass,dd){
	...
	j("#setAjax").setAjax({
		url : base_url+"Kingpenguji/reRegisterPengujiTA.aspx",
		bool : true,
...
function reloadPengujiTA1Dosen(){
	...
	j("#setAjax").setAjax({
		url : base_url+"Kingpenguji/getTablePengujiTA1.aspx",
		methode : "post",
...
function reloadPengujiTA2Dosen(){
	...
	j("#setAjax").setAjax({
		url : base_url+"Kingpenguji/getTablePengujiTA2.aspx",
		methode : "post",
...
function realBannishMeFromHerTA(a,b){
	...
	j("#setAjax").setAjax({
		url : base_url+"Kingpenguji/banishLeaderOrMember.aspx",
		methode : "post",
...
function reloadPengujiTA2DosenPembantu(){
	...
	j("#setAjax").setAjax({
		url : base_url+"Kingpenguji/getDataNipsOrNipd.aspx",
		methode : "post",
