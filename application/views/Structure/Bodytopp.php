  ...
  <div class='row header-static'>
    <div class=col-md-12>
      <nav class="navbar" role=navigation>
          ...
          <a class=navbar-brand><img src="<?php echo base_url();?>resources/mystyle/image/undip.png"/></a> 
        </div>
        <div class="collapse navbar-collapse navbar-ex1-collapse back-black-blur grey-blur">
          <ul class="nav navbar-nav">
            <li><a id="seminar-layout" class="pointer  grey-blur" data-toggle=dropdown><span class=icon-pencil></span> Tabel Acara </a></li>
